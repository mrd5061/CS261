...
{	
	//Make sure newCap is a positive integer.
	assert(newCap > 0);
	//create the new array
	DynArr* temp = newDynArr(newCap);

	//translate the information from the old array
	//to the new array.
	...
	//make the old array pointer point to the new array.
	*v = *temp;
